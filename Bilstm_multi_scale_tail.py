...
def tail_padding(num, max_length):
    pad_index = 0
    tail_padding_list = []
    for protein in num:
...
def collate_fn(data): 
    ...
    tail1 = tail_padding(data_num, max_length1)
    tail2 = tail_padding(data_num, max_length2)
    tail3 = tail_padding(data_num, max_length3)
    ...
    return (tail1, tail2, tail3), data_label_ten   
...
if __name__== '__main__':
    ...
    for time in range(len(pos_seed_list)):
        ...
        save_csv_path = './output_dir/Bilstm_MS_output/Bilstm_MS3_Tail_em512_512_1_mydata_{}.csv'.format((time+1)) 

...
def collate_fn(data): 
    ...
    return (head1, tail1), data_label_ten   
...
if __name__== '__main__':
    ...
    for time in range(len(pos_seed_list)):
        ...
        save_csv_path = './output_dir/Bilstm_MS_output/Bilstm_HeadTail_em512_512_1_mydata_{}.csv'.format((time+1)) 
        ...
        for fold, (train_val_idx, test_idx) in enumerate(skf.split(X, Y)):       # train:val:test=7:1:2 /6:2:2
            ...
            model = Net_multi(1, len(vocab)+1, 512, 512, 1, True)  # 512,256,1, hidden128表示256,128,1, em512:512,100,1 
